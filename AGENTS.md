# Arts and Sports — ADT Bundle Reference
...
**Arts and Sports** — This is an English-language Arts and Sports pupil’s book for Standard Three in mainland Tanzania, published by the Tanzania Institute of Education, so it is aimed at roughly primary Grade 3 learners. It introduces basic performing and visual arts and physical activities, including acting, singing, musical instruments, drawing, clay modelling, physical exercise, traditional games, and participation in exhibitions and competitions. The book uses a practical, activity-based approach with simple explanations, pictures, exercises, and community-centered examples, emphasizing creativity, talent development, culture, teamwork, health, and skills that can support confidence and even future income generation.
...
├── ARTS---SPORTS-02.12.23.db                    # SQLite database (pipeline state)
├── ARTS---SPORTS-02.12.23.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg006_im001": "QR code linking to the Tanzania Institute of Education e-library resources",
  "gl001": "accompany",
  "gl001_def": "to play or sing along with another singer or instrument",
  "qz001_que": "What is the performing place in acting called?",
  "qz001_o0": "1) audience",
  "qz001_o0_exp": "❌ Not quite. The audience are the people who watch the performance."
}
```
...
```json
{
  "accompany": {
    "word": "accompany",
    "definition": "to play or sing along with another singer or instrument",
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">What is the performing place in acting called?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="❌ Not quite. The audience are the people who watch the performance." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) audience</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `ARTS---SPORTS-02.12.23.pdf` |
| Pipeline database | `ARTS---SPORTS-02.12.23.db` (SQLite) |
